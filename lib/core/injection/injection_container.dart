...
Future<void> init() async {
 sl.registerFactory(() => GetCategoriesCubit(usecase: sl()));
  ...
  // تسجيل LogoutUsecase و LogoutCubit
  sl.registerLazySingleton(() => LogoutUsecase(repository: sl())); // تسجيل LogoutUsecase
  sl.registerFactory(() => LogoutCubit(logoutUsecase: sl())); // تسجيل LogoutCubit

  // تسجيلات خدمات الملف الشخصي
