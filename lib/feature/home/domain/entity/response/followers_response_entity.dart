...
class FollowersResponseEntity {
  ...
  FollowersResponseEntity.fromJson(dynamic json) {
    ...
    _data = json['data'] != null ? FollowersData.fromJson(json['data']) : null;
    // if (json['errors'] != null) {
    //   _errors = [];
...
FollowersData dataFromJson(String str) => FollowersData.fromJson(json.decode(str));
String dataToJson(FollowersData data) => json.encode(data.toJson());
class FollowersData {
  FollowersData({
      List<User>? data,
...
FollowersData copyWith({  List<User>? data,
  Pagination? pagination,
}) => FollowersData(  data: data ?? _data,
