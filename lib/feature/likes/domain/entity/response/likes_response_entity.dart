...
LikesResponseEntity likesResponseEntityFromJson(String str) => LikesResponseEntity.fromJson(json.decode(str));
String likesResponseEntityToJson(LikesResponseEntity data) => json.encode(data.toJson());
class LikesResponseEntity {
  LikesResponseEntity({
      bool? success, 
      String? message, 
      LikesData? data, 
  ...
  LikesResponseEntity.fromJson(dynamic json) {
    _success = json['success'];
    _message = json['message'];
    _data = json['data'] != null ? LikesData.fromJson(json['data']) : null;
    // if (json['errors'] != null) {
    //   _errors = [];
...
LikesResponseEntity copyWith({  bool? success,
  String? message,
  LikesData? data,
  List<dynamic>? errors,
}) => LikesResponseEntity(  success: success ?? _success,
...
LikesData dataFromJson(String str) => LikesData.fromJson(json.decode(str));
String dataToJson(LikesData data) => json.encode(data.toJson());
class LikesData {
  LikesData({
  ...
  LikesData.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
...
LikesData copyWith({  List<AdvDetails>? data,
  Pagination? pagination,
}) => LikesData(  data: data ?? _data,
