...
CheckUpdateAvailabilityResponseEntity
    checkUpdateAvailabilityResponseEntityFromJson(String str) =>
        CheckUpdateAvailabilityResponseEntity.fromJson(json.decode(str));
String checkUpdateAvailabilityResponseEntityToJson(
        CheckUpdateAvailabilityResponseEntity data) =>
...
class CheckUpdateAvailabilityResponseEntity {
  ...
  CheckUpdateAvailabilityResponseEntity copyWith({
    bool? success,
    String? message,
    Data? data,
    List<dynamic>? errors,
...
class Data {
  ...
  Data copyWith({
    String? versionUpdate,
      ...
      Data(
        versionUpdate: versionUpdate ?? _versionUpdate,
      );
