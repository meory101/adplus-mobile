...
class InReviewListView extends StatelessWidget {
  const InReviewListView({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<MyitemUnderReviewCubit, MyitemUnderReviewState>(
      ...
      builder: (context, state) {
        ...
        List<AdData> items = state.entity.data?.data ?? [];
                    ...
                    children: [
                      Container(
                        ...
                        child: MainImageWidget(
                          imageUrl: AppConstantManager.imageBaseUrl +((items[index].photos??[]).isNotEmpty?
