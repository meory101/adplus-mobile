        ...
        listener: (context, state) {
          ...
          if (state.status == CubitStatus.success) {
            NoteMessage.showSuccessSnackBar(
                context: context, text: "yourAdUnderReview".tr());
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () async {
                          List<File?>? selectedFiles =
                              await AppImageHelper.pickMultiImagesFrom();
                          if ((selectedFiles ?? []).length > 10 ||
                              (advFiles.length + (selectedFiles ?? []).length) >
                                  10) {
                            return NoteMessage.showErrorSnackBar(
                                context: context, text: "maximum10Images".tr());
                          }
              ...
              Visibility(
                visible: AdvertisementModel.entity?.startingPrice!=null,
                child:  Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  SizedBox(height: AppHeightManager.h2point5),
